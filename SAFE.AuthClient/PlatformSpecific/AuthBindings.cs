...
namespace SAFE.AuthClient.Native
{
    public partial class AuthBindings : IAuthBindings
    {
...
#else
        const string DllName = "safe_authenticator";
#endif
        ...
        static extern bool AuthIsMockNative();

        [DllImport(DllName, EntryPoint = "create_acc")]
        static extern void CreateAccNative(
        ...
        static extern void LoginNative(
            [MarshalAs(UnmanagedType.LPStr)] string accountLocator,
            [MarshalAs(UnmanagedType.LPStr)] string accountPassword,
            IntPtr userData,
            NoneCb oDisconnectNotifierCb,
        ...
        static extern void AuthReconnectNative(IntPtr auth, IntPtr userData, FfiResultCb oCb);
        ...
        static extern void AuthAccountInfoNative(IntPtr auth, IntPtr userData, FfiResultAccountInfoCb oCb);
        ...
        static extern void AuthExeFileStemNative(IntPtr userData, FfiResultStringCb oCb);
        ...
        static extern void AuthSetAdditionalSearchPathNative(
        ...
        static extern void AuthFreeNative(IntPtr auth);
        ...
        static extern void AuthRmRevokedAppNative(
            IntPtr auth,
        ...
        static extern void AuthRevokedAppsNative(IntPtr auth, IntPtr userData, FfiResultAppExchangeInfoListCb oCb);
        ...
        static extern void AuthRegisteredAppsNative(IntPtr auth, IntPtr userData, FfiResultRegisteredAppListCb oCb);
        ...
        static extern void AuthAppsAccessingMutableDataNative(
            IntPtr auth,
        ...
        static extern void AuthUnregisteredDecodeIpcMsgNative(
        ...
        static extern void AuthDecodeIpcMsgNative(
            IntPtr auth,
            [MarshalAs(UnmanagedType.LPStr)] string msg,
            IntPtr userData,
            UIntAuthReqCb oAuth,
        ...
        static extern void EncodeShareMDataRespNative(
            IntPtr auth,
        ...
        static extern void AuthRevokeAppNative(
            IntPtr auth,
            [MarshalAs(UnmanagedType.LPStr)] string appId,
            IntPtr userData,
            FfiResultStringCb oCb);
        ...
        static extern void AuthFlushAppRevocationQueueNative(IntPtr auth, IntPtr userData, FfiResultCb oCb);
        ...
        static extern void EncodeUnregisteredRespNative(
            uint reqId,
            [MarshalAs(UnmanagedType.U1)] bool isGranted,
            IntPtr userData,
            FfiResultStringCb oCb);
        ...
        static extern void EncodeContainersRespNative(
            IntPtr auth,
        ...
        static extern void AuthInitLoggingNative(
        ...
        static extern void AuthOutputLogPathNative(
            [MarshalAs(UnmanagedType.LPStr)] string outputFileName,
            IntPtr userData,
            FfiResultStringCb oCb);

        delegate void FfiResultAccountInfoCb(IntPtr userData, IntPtr result, IntPtr accountInfo);
        ...
        static readonly FfiResultAccountInfoCb DelegateOnFfiResultAccountInfoCb = OnFfiResultAccountInfoCb;

        delegate void FfiResultAppAccessListCb(IntPtr userData, IntPtr result, IntPtr appAccessPtr, UIntPtr appAccessLen);
        ...
        static readonly FfiResultAppAccessListCb
            DelegateOnFfiResultAppAccessListCb = OnFfiResultAppAccessListCb;

        delegate void FfiResultAppExchangeInfoListCb(
            IntPtr userData,
            IntPtr result,
        ...
        static readonly FfiResultAppExchangeInfoListCb DelegateOnFfiResultAppExchangeInfoListCb =
            OnFfiResultAppExchangeInfoListCb;

        delegate void FfiResultAuthenticatorCb(IntPtr userData, IntPtr result, IntPtr authenticator);

        delegate void FfiResultCb(IntPtr userData, IntPtr result);
        ...
        static readonly FfiResultCb DelegateOnFfiResultCb = OnFfiResultCb;

        delegate void FfiResultRegisteredAppListCb(IntPtr userData, IntPtr result, IntPtr registeredAppPtr, UIntPtr registeredAppLen);
        ...
        static readonly FfiResultRegisteredAppListCb DelegateOnFfiResultRegisteredAppListCb =
            OnFfiResultRegisteredAppListCb;

        delegate void FfiResultStringCb(IntPtr userData, IntPtr result, string response);
        ...
        static readonly FfiResultStringCb DelegateOnFfiResultStringCb = OnFfiResultStringCb;

        delegate void NoneCb(IntPtr userData);

        delegate void UIntAuthReqCb(IntPtr userData, uint reqId, IntPtr req);

        delegate void UIntByteListCb(IntPtr userData, uint reqId, IntPtr extraDataPtr, UIntPtr extraDataLen);

        delegate void UIntContainersReqCb(IntPtr userData, uint reqId, IntPtr req);

        delegate void UIntShareMDataReqMetadataResponseListCb(IntPtr userData, uint reqId, IntPtr req, IntPtr metadataPtr, UIntPtr metadataLen);
    }
}
#endif